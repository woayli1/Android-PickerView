...
import com.woayli1.pickerview.listener.OnOptionsSelectChangeListener;
...
import com.woayli1.pickerviewdemo.bean.CardBean;
import com.woayli1.pickerviewdemo.bean.ProvinceBean;
    ...
    private void initTimePicker() {//Dialog 模式下，在底部弹出
        ...
        if (mDialog != null) {
            ...
            if (dialogWindow != null) {
                dialogWindow.setWindowAnimations(com.woayli1.pickerview.R.style.picker_view_slide_anim);//修改动画样式
